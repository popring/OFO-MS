...
class FormRegister extends React.Component<FormComponentProps> {
  state = {
    userImg: ''
  };
          ...
          <Form>
            <FormItem label="用户名" {...formItemLayout}>
              {getFieldDecorator('userName', {
                rules: [{ required: true, message: '用户名别忘了写哦' }]
              })(<Input />)}
            </FormItem>
            <FormItem label="密码" {...formItemLayout}>
              {getFieldDecorator('userPwd', {
                rules: [{ required: true, message: '密码别忘了写哦' }]
              })(<InputPassword />)}
            </FormItem>
            ...
            <FormItem label="生日" {...formItemLayout}>
              {getFieldDecorator('birthday', {
                initialValue: moment('1998-11-02')
              })(
                <DatePicker
            ...
            <FormItem label="联系地址" {...formItemLayout}>
              ...
              })(<TextArea autoSize={{ minRows: 2, maxRows: 6 }} placeholder="请输入地址" />)}
            </FormItem>
            <FormItem label="头像" {...formItemLayout}>
              <Upload
                ...
                {userImg ? <img src={userImg} style={{ width: 104, height: 104 }} alt="img" /> : <Icon type="plus" />}
              </Upload>
            </FormItem>
          </Form>
        </Card>
